...
export function HomePageClient() {
  return (
    <div className="md:mx-auto md:flex md:w-full md:max-w-(--breakpoint-sm) md:max-w-[1200px] md:flex-col md:items-center md:items-start! md:gap-8">
      <Gallery
                ...
                <div className="flex flex-col py-4 sm:border-r sm:border-b sm:p-4 sm:pl-0 dark:border-gray-500/20">
                  <p className="mb-1 flex items-center gap-2 text-sm text-black dark:text-white">
                    <span className="shrink-0">
                      <Server className="icon-base" />
                    </span>
                    Remote Development
                  </p>
                  <p className="text-left text-sm [text-wrap:pretty]">
      ...
      <Testimonials
        ...
        testimonials={{
          best: {
            ...
            description:
              'Zed is the best thing that has happened to our team. We are able to collaborate and work on projects seamlessly.',
          },
          others: [
            {
              name: 'Ali Veli',
