    ...
    return (
        <div>
            ...
            <div className="flex min-h-screen items-center justify-center overflow-hidden p-6 md:p-0">
                <div className="relative z-20 h-full flex items-center justify-center w-full max-w-[380px] flex-col py-8">
                    <div className="relative flex w-full flex-col">
                        <div className="inline-block bg-gradient-to-r from-[#FAFAFA] to-[#000] bg-clip-text pb-4 text-transparent dark:via-[#FAFAFA] dark:to-[#848484]">
                            <h1 className="pb-1 text-5xl font-medium font-lora italic">Giriş Yap.</h1>
                        </div>

                        <div className="py-4 pb-6 text-2xl font-medium text-[#878787]">
                            Kontrol Paneli. <br />
                            Sitenizin performansını takip edin. <br />
                            <WordAnimation className="text-accent-blue dark:text-blue-300 italic font-mono pt-2 leading-relaxed tracking-tighter" />
                        </div>
